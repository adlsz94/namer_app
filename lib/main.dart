/**
  ...
  //https://codelabs.developers.google.com/codelabs/flutter-codelab-first?hl=pt-br#5
  void main() {
    runApp(MyApp());
  }
  ...
  class MyAppState extends ChangeNotifier {
    ...
    // Add this property to keep track of favorites
  ...
  class _MyHomePageState extends State<MyHomePage> {
    ...
    Widget build(BuildContext context) {
      ...
      // The container for the current page, with its backgronund color
        ...
        body: LayoutBuilder(
          builder: (context, constraints) {
            if (constraints.maxWidth < 450) {
              // Use a more mobile-friendly layout with a BottomNavigation
              // on narrow screens.
              return Column(
                children: [
                  Expanded(
